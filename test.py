...
def test_delete_questions():
    Questions.createQuestion("Question", "Please Answer", "software", 1)
    Questions.createQuestion("Question2", "Please Answer", "software", 1)
    Questions.createQuestion("Question3", "Please Answer", "software", 1)
    Questions.deleteQuestion(3)
    question1 = Questions.getQuestion(1)
    question2 = Questions.getQuestion(2)
    question3 = Questions.getQuestion(3)
	
	
    if question1 and question2 and not question3:
        return 0
    else:
        return 1
...
def test_answers():
    ...
    Answers.createAnswer("My Answer", 2, 10)
    Answers.createAnswer("My Answer", 3, 1)
    Answers.createAnswer("My Answer", 3, 2)
    Answers.deleteAnswer(2)
    Answers.deleteAnswer(4)
    answer1 = Answers.getAnswersByQuestion(10)
    answer2 = Answers.getAnswersByQuestion(1)
    answer3 = Answers.getAnswersByQuestion(2)
...
if __name__ == '__main__':
    ...
    if return_code != 0:
        print("backend Test failed at User, Rc=" + str(return_code))
        exit(return_code)
    return_code = test_delete_questions()
    if return_code != 0:
